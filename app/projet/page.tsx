...
export default function Projet () {
    return ( 
        <section className="sm:p-20 mt-0 sm:align-items  justify-center">
            ...
            <div id="animRotate" className='border-solid border-2 border-red-50 w-[461px] h-[260px] flex sm:justify-center items-center'>
                <div id="projet" >
                    <Image  
                ...
                <div className=' w-[461px] h-[260px] flex items-center justify-center' id="projet_hid">
