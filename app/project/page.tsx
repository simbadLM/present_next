                            ...
                            <div className="w-full max-w-3xl mx-auto">
                                ...
                                <div className="-my-6">
                                    ...
                                    <div className="relative pl-8 sm:pl-32 py-6 group">
                                        ...
                                        <div className="text-gray-400 font-semibold ">Un premier projet dans le cadre du BTS SIO ayant pour but principal d&apos;apprendre à manipuler JavaScript. Il a consisté à réaliser une application web de jeu du BlackJack.</div>
                                    </div>
                                    ...
                                    <div className="relative pl-8 sm:pl-32 py-6 group">
                                        ...
                                        <div className="text-gray-400 font-semibold ">
                                            ...
                                            <p>Les styles sont quasiement exclusivemrnt réalisés en Tailwind CSS.</p>
                                        </div>
                                        <div className="text-[#a5b4fc] hover:font-semibold"><a target="_blank" href="https://github.com/simbadLM/present_next"><p>→ Lien GitHub ←</p></a></div>
                                    </div>
                                    
                                    <div className="relative pl-8 sm:pl-32 py-6 group">
                                        <div className="font-caveat font-medium text-2xl text-[#a5b4fc] mb-1 sm:mb-0">Click & Clean (client lourd)</div>
                                        <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 sm:before:ml-[6.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600 after:border-4 after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2 after:translate-y-1.5">
                                            ...
                                            <div className="text-l italic text-white">Java, JavaFX, Maven, MySQL</div>
                                        </div>
                                        <div className="text-gray-400 font-semibold ">
                                            <p>Click & Clean est une application de mise en relation entre prestataires de ménage et propriétaires de biens.</p>
                                        </div>
                                        <div className="text-[#a5b4fc] hover:font-semibold"><a target="_blank" href="https://github.com/simbadLM/ClickNClean"><p>→ Lien GitHub ←</p></a></div>
                                    </div>

                                    <div className="relative pl-8 sm:pl-32 py-6 group">
                                        <div className="font-caveat font-medium text-2xl text-[#a5b4fc] mb-1 sm:mb-0">Click & Clean (client léger)</div>
                                        <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 sm:before:ml-[6.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600 after:border-4 after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2 after:translate-y-1.5">
                                            <time className="sm:absolute left-0 translate-y-0.5 inline-flex items-center justify-center text-xs font-semibold uppercase w-20 h-6 mb-3 sm:mb-0 text-black bg-[#a5b4fc] rounded-full">02/2024</time>
                                            <div className="text-l italic text-white">J2EE, Maven, MySQL</div>
                                        </div>
                                        <div className="text-gray-400 font-semibold ">
                                            <p>Click & Clean version web, avec un serveur Tomcat.</p>
                                        </div>
                                        <div className="text-[#a5b4fc] hover:font-semibold"><a target="_blank" href="https://github.com/simbadLM/ClickNClean_j2ee"><p>→ Lien GitHub ←</p></a></div>
                                    </div>
                                    ...
                                    <div className="relative pl-8 sm:pl-32 py-6 group">
                                        ...
                                        <div className="text-gray-400 font-semibold ">
                                            <p>Ce projet consiste à réaliser une centrale inertielle et à l&apos;utiliser pour intéragir avec le simulateur de vol FlightGear et des instruments de vol (interface web).</p>
                                        ...
                                        <div className="text-[#a5b4fc] hover:font-semibold"><a target="_blank" href="https://github.com/simbadLM/centrale_inertielle"><p>→ Lien GitHub ←</p></a></div>
                                    </div>
